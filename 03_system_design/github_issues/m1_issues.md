...
- [x] `[2026-05-24]` 아트 스타일 가이드 초안 작성 (art_style_guide.md v0.1)
- [x] `[2026-05-24]` 아트 스타일 가이드 v0.2 — 전체 톤 만화풍 변경
- [x] `[2026-05-24]` 아트 스타일 가이드 v0.3 — 음식 수채화 손그림 스타일 전면 재정의, GDD 접시 형태 연동, ComfyUI 프롬프트 기준 추가
